        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value">{{ \Carbon\Carbon::parse($ticket->DateCreation)->format('d/m/Y H:i') }}</span>
                </div>
                <div class="detail-item">
                    <span class="detail-label">Date de fin :</span>
                    <span class="detail-value">{{ \Carbon\Carbon::parse($ticket->DateFinReelle)->format('d/m/Y H:i') }}</span>
                </div>
            </div>
